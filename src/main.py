from tabular_learning import training, select_action_greedy, steady_decrease_epsilon, test_q, select_action_softmax, dynamic_base
...
def GreedyQlearning():
    ...
    Q = training(num_episodes, select_action_greedy, 
                 steady_decrease_epsilon, alpha, gamma, 
                 "Epsilon with Greedy policy", max_steps, 
                 env)
...
def dynamicSoftmaxQlearning():
    ...
    num_episodes = 10_000
    max_steps = 1000   # Max steps per episode
    Q = training(num_episodes, select_action_softmax, 
                 dynamic_base, alpha, gamma, 
                 "Base of softmax (Softmax policy)", max_steps, 
                 env)
...
def DQN_learning(need_trainig=True):
    ...
    print("Testing the success rate of the agent over 10 000 episodes")
...
if __name__ == "__main__":
    ...
    print("Softmax Tabulat Qlearning")
